...
from app.services.memory_v2.extraction_contracts import ModelExtractionInput
...
PROMPT_VERSION = "phase4-schema-v1"
...
class FixtureExtractionModel:
    ...
    def __init__(
        ...
        *,
        model_version: str = "phase4-fixture-v1",
...
# Compatibility import for callers that intentionally use a direct-schema endpoint.
JsonHttpExtractionModel = DirectJsonExtractionProvider
