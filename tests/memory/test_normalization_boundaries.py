...
from app.services.memory.planner import PlannerContext, PlannerState, plan_memory_mutation
from app.services.memory.taxonomy import MemoryType
from tests.memory.helpers import OWNER_A, OWNER_B, actor, candidate, source
...
def test_planner_is_pure_and_deterministic(test_crypto) -> None:
    ...
    context = PlannerContext(
        ...
        source=__import__(
            "app.services.memory.normalization",
...
def test_kernel_has_no_derived_or_external_service_dependency() -> None:
    import app.services.memory.mutations as mutations
    import app.services.memory.planner as planner
