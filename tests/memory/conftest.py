...
from tests.memory.factories import DATABASE_IDENTITY as PHASE1_DATABASE_IDENTITY
from tests.memory.factories import OWNER_A as PHASE1_OWNER_A
...
def memory_engine(tmp_path):
    engine = build_engine(f"sqlite:///{tmp_path / 'memory.db'}")
    upgrade_memory(
        engine,
