...
from app.services.memory_v2.taxonomy import Cardinality
...
def test_same_key_and_slot_are_independent_across_owner_databases(tmp_path, test_crypto) -> None:
    ...
    upgrade_memory_v2(first_engine, owner_id=OWNER_A, database_identity=DATABASE_IDENTITY)
    upgrade_memory_v2(second_engine, owner_id=OWNER_B, database_identity=second_identity)
    try:
