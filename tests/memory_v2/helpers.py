...
class DeterministicTestCrypto:
    ...
    _encryption_key: bytes = b"memory-v2-test-encryption-material"
    _fingerprint_key: bytes = b"memory-v2-test-fingerprint-material"
    _tombstone_key: bytes = b"memory-v2-test-tombstone-material"
